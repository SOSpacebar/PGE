...
#endif // #define CC_PlatForm_IOSusing namespace cocos2d::ui;

using namespace cocos2d::ui;
USING_NS_CC;

Scene* WinMenu::createScene()
{
	auto scene = WinMenu::create();
...
bool WinMenu::init()
{
	...
	auto background = Sprite::create("WinMenu.png");
	...
	keyboardListener->onKeyPressed = CC_CALLBACK_2(WinMenu::onKeyPressed, this);
	keyboardListener->onKeyReleased = CC_CALLBACK_2(WinMenu::onKeyReleased, this);
	_eventDispatcher->addEventListenerWithSceneGraphPriority(keyboardListener, this);

	// Mouse Event
	auto mouseListener = EventListenerMouse::create();
	mouseListener->onMouseMove = CC_CALLBACK_1(WinMenu::onMouseMove, this);
	mouseListener->onMouseUp = CC_CALLBACK_1(WinMenu::onMouseUp, this);
	mouseListener->onMouseDown = CC_CALLBACK_1(WinMenu::onMouseDown, this);
	mouseListener->onMouseScroll = CC_CALLBACK_1(WinMenu::onMouseScroll, this);
...
void WinMenu::menuCloseCallback(Ref* pSender)
{
...
void WinMenu::update(float delta)
{
...
void WinMenu::onKeyPressed(EventKeyboard::KeyCode keyCode, Event* event)
{
	switch (keyCode)
	{
...
void WinMenu::onKeyReleased(EventKeyboard::KeyCode keyCode, Event* event)
{
	//mainCharacter.MoveChar(EAction::eStop);
	log("Key with keycode %d released", keyCode);
}

void WinMenu::onMouseMove(Event * mouse)
{
...
void WinMenu::onMouseUp(Event * mouse)
{
	EventMouse* eventMouse = static_cast<EventMouse*>(mouse);
	EventMouse *e = (EventMouse*)mouse;
...
void WinMenu::onMouseDown(Event * mouse)
{
	
}

void WinMenu::onMouseScroll(Event * mouse)
{
}
